...
function check1(btn){
  // 매개변수 btn : 함수 호출 시, 괄호 안에 작성된 
  //                check1(this)에 this가 대입
...
// -> 보통 이벤트 핸들러로 작성 시 많이 사용됨


test1a.onclick = function(){
  
  // 고전 이벤트 모델 -
  // 이벤트 핸들러 내에서 this == 클릭된 요소(이벤트 발생 요소)
  console.log(this);
...
/* [작성법] 
    ...
    요소.addEventListener("이벤트종류", 이벤트 핸들러);
...
test2.addEventListener("click",function(){
  ...
  */
  // 현재 요소에 inline style로 작성된 투명도를 얻어오기
